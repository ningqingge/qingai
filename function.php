...
if (!function_exists('qingBotBlock_LogFile')) {
    ...
    {
        echo '<link rel="stylesheet" type="text/css" href="' . qingBotBlock_AssetUrl('css/admin.css') . '" />' . "\n";
    }
    ...
    function qingBotBlock_PostBody()
    {
        ...
        if (isset($_POST['custom_body_b64']) && $_POST['custom_body_b64'] !== '') {
            $raw = base64_decode(str_replace(' ', '+', (string) $_POST['custom_body_b64']), true);
            if ($raw !== false) {
                return $raw;
            }
        }
    ...
    function qingBotBlock_ReadLog($limit)
    {
        ...
        $result['rows'] = array_slice(array_reverse($rows), 0, $limit);
        return $result;
    }
