  ...
  <div class="qbb">
    ...
    <div class="qbb-hero">
      <div class="qbb-hero-main">
        <img class="qbb-hero-logo" src="<?php echo qingBotBlock_AssetUrl('logo.png'); ?>" alt="" />
...
<?php else: ?>
    ...
    <div class="qbb-card">
      <div class="qbb-card-hd">
        ...
        <div class="qbb-tools">
          <form method="post" action="./main.php" onsubmit="return confirm('确定清空全部拦截日志吗？此操作不可恢复。');">
            <input type="hidden" name="csrfToken" value="<?php echo $zbp->GetCSRFToken(); ?>">
...
<?php endif; ?>
    ...
    <div class="qbb-foot">
      <span class="qbb-foot-tip">自测：终端执行 <code>curl -A "GPTBot" <?php echo qingBotBlock_SiteUrl(); ?></code>，返回 403 或你设置的拦截页即表示本插件生效</span>
      <span class="qbb-sign">v<?php echo qingBotBlock_Ver(); ?> &nbsp;&copy; <?php echo date('Y'); ?> <a href="https://jiyun.xin/yun/" target="_blank" rel="noopener">清歌</a></span>
    </div>

  </div>
  </div>
</div>
<script type="text/javascript">window.QBB = {"ver": <?php echo json_encode(qingBotBlock_Ver()); ?>, "rules": <?php echo json_encode(qingBotBlock_DefaultRules()); ?>, "body": <?php echo json_encode(qingBotBlock_DefaultBody()); ?>, "site": <?php echo json_encode(qingBotBlock_SiteUrl()); ?>, "css": <?php echo json_encode(qingBotBlock_AssetUrl('css/preview.css')); ?>, "hints": <?php echo json_encode($content_hint); ?>};</script>
<script type="text/javascript" src="<?php echo qingBotBlock_AssetUrl('js/admin.js'); ?>"></script>
<script type="text/javascript">ActiveLeftMenu("aPluginMng");</script>
<script type="text/javascript">AddHeaderIcon("<?php echo qingBotBlock_AssetUrl('logo.png'); ?>");</script>
<?php
